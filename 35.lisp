...
(defun print-pretty (arr1 arr2)
	(format t "List1 = ~a, List2 = ~a, 2 is subset of 1-st? => ~a~%" arr1 arr2 (is-subset arr1 arr2))
)

(defun print-pretty-own (arr1 arr2)
	(format t "List1 = ~a, List2 = ~a, 2 is own subset of 1-st? => ~a~%" arr1 arr2 (is-own-subset arr1 arr2))
)
